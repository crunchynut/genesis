...
/**
 * Generates SHA1 password required for WebLogic Portal.
 * Accepts cleartext source password and property to store result
 * @author Mike Mochan
...
public class Sha1Gen extends Task {
    ...
    /** @param sourcepwd accepts a string, sets source password */
