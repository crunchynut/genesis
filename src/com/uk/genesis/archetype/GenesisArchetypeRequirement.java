...
public class GenesisArchetypeRequirement {
     ...
     * @param qnameProperty the property that
     * the qualified object name will be exposed under.
     * @param nameProperty the property that the
     * local object name will be exposed under.
     */
    public GenesisArchetypeRequirement(final GenesisObjectType type,
            final String qnameProperty, final String nameProperty) {
        this.type = type;
    ...
    /**
     * Retrieves the name of the property that the
     * qualified object instance will be exposed under.
