...
/**
 * Creates a filterset using the provided object. This
...
public class LoadConfig extends BaseGenesisTask {
        ...
        for (GenesisObjectReference ref : objects) {
            if (ref.isValid(getProject())) {
                try {
                    ...
                    throw new BuildException("Failed to find type "
                            + ref.getType() + " - " + ex.getMessage(),
                            ex, getLocation());
    ...
    public void setMyPrefix(final String myPrefix) {
